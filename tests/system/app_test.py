...
class AppTest(TestCase):
    ...
    def test_menu_calls_print_blogs_2(self):
        with patch('builtins.input') as mocked_input:
            with patch('app.print_blogs') as mocked_list_blogs:
    ...
    def test_print_blogs(self):
        with patch('builtins.print') as mocked_print:
            ...
            mocked_print.assert_called_with(
                'Test: Blog(title=Test, author=Test Author, Posts=[])')

    def test_ask_create_blog(self):
        with patch('builtins.input') as mocked_input:
            # side effect each time function is called,
            # first time with test, second time with test author
